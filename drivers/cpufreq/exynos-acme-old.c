...
/*physwizz underclocking, foxiy variable*/
...
/*Chatur, Carlos Burero & physwizz, foxiy variables*/
...
unsigned long arg_cpu_max_c2 = 2106000; /*max_cpu_freq=2.1 GHz*/
